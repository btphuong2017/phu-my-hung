<div class="sidebar">
    <div class="sidebar-inner">
        ...
        <div class="sidebar-logo">
            <div class="peers ai-c fxw-nw">
                <div class="peer peer-greed">
                    <a class="sidebar-link td-n" href="{{ admin_url('') }}">
                        <div class="peers ai-c fxw-nw">
                            <div class="peer">
                                <div class="logo">
                            ...
                            <div class="peer peer-greed">
                                <h5 class="lh-1 mB-0 logo-text">Amit Group</h5>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <ul class="sidebar-menu scrollable pos-r">
            <li class="nav-item mT-30 {{ request()->is('admin') ? 'actived' : '' }}">
                <a class="sidebar-link" href="{{ admin_url() }}">
            ...
            <li class="nav-item {{ request()->is('admin/setting/*') ? 'actived' : '' }}">
                <a class="sidebar-link" href="{{ admin_url('setting') }}">
                    <span class="icon-holder">
